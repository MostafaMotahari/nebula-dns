...
export default function IPv6InstructionsPage() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className="relative z-10 container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-12 animate-fade-in">
          <h1 className="text-4xl font-bold text-white mb-4">IPv6 Connection Instructions</h1>
          <p className="text-xl text-slate-300 max-w-2xl mx-auto">
            Follow these steps to configure your device to use our IPv6 DNS servers.
          </p>
        </div>
        ...
        <div className="max-w-md mx-auto mb-12">
          <Card className="bg-white/10 backdrop-blur-lg border-white/20">
            <CardHeader>
              <CardTitle className="text-xl font-bold text-white">IPv6 DNS Addresses</CardTitle>
              ...
              <Card className="bg-white/10 backdrop-blur-lg border-white/20">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-slate-300">
                      Change "IP Settings" to "Static" and scroll down to the IPv6 DNS fields.
                    </p>
                  </div>
                  <div className="space-y-2">
